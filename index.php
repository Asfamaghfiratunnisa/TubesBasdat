...
<html lang="en">
  ...
  <body>
        ...
        <div id="collapsingMobileUser" class="collapse navbar-toggleable-custom dropdown-menu-custom p-x-1 hidden-md-up" role="tabpanel" aria-labelledby="collapsingMobileUser">
          <div class="media m-t-1">
            ...
            <div class="media-body media-middle">
              <h5 class="media-heading">Asfa Maghfiratunnisa</h5>
              <h6>asfamaghfiratunnsia3008@gmail.com</h6>
            </div>
          </div>
    ...
    <header class="jumbotron bg-inverse text-xs-center center-vertically" role="banner">
      <div class="container">
        <h1 class="display-3">LaLaundry  </h1>
        <h2 class="m-b-3">Bersih, <em>Wangi</em>, dan Ekonomis <br><a href="ui-elements.html" class="jumbolink">powered by Asfa Maghfiratunnisa</a>.</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-7">
            <ul class="nav nav-inline">
              <li class="nav-item">
                <a class="nav-link" href="">Untuk Memenuhi Mata Kuliah Basis Data<span class="sr-only"></span></a>
              </li>
            </ul>
          </div>
        </div>
